...
const SLIDES = [
  {
    ...
    body: "Discover 500+ verified doctors across Janakpurdham and book confirmed appointments in seconds.",
    img: "https://images.unsplash.com/photo-1612349316228-5942a9b489c2?w=600&q=80",
  },
  {
    icon: "document-text" as const,
    title: "All Your Records in One Place",
    body: "E-prescriptions, lab reports, X-rays, vaccinations — securely stored and always with you.",
    img: "https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=600&q=80",
  },
  {
    icon: "medical" as const,
    title: "Emergency Help, One Tap Away",
    body: "Instantly connect to nearby hospitals, ambulances, and blood banks in Janakpurdham.",
    img: "https://images.pexels.com/photos/5364345/pexels-photo-5364345.jpeg?auto=compress&w=600",
  },
];
