...
export default function Login() {
  ...
  const { login } = useAuth();
  const [email, setEmail] = useState("patient@hamrodoctor.np");
  ...
  const submit = async () => {
    ...
    try {
      ...
      else if (u.role === "super_admin") router.replace("/(admin)");
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }} edges={["top", "bottom"]}>
      ...
      >
        <ScrollView contentContainerStyle={styles.wrap} keyboardShouldPersistTaps="handled">
          ...
          <Text style={styles.sub}>Sign in to continue to HamroDoctor</Text>
          ...
          <View style={styles.demoBox}>
            ...
            <View style={{ flex: 1, marginLeft: 6 }}>
              ...
              <Text style={styles.demoTxt}>Super Admin: super@hamrodoctor.np / Super@123</Text>
            </View>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
